 ...
 * ```
 */
export declare function getMetadata(source: string, options?: MetadataOptions): Promise<Metadata>;
/**
 ...
 */
export declare function getTracks(source: string, options?: MetadataOptions): Promise<TrackInfo[]>;
/**
 ...
 */
export declare function getCover(source: string, options?: MetadataOptions): Promise<CoverInfo | null>;
/**
 ...
 */
export declare function getSubtitles(source: string, options?: SubtitleOptions): Promise<SubtitleInfo[]>;
/**
 ...
 */
export declare function getThumbnails(source: string, options: ThumbnailsOptions): Promise<ThumbnailInfo[]>;
/**
 ...
 * ```
 */
export declare function getDurationInSeconds(metadata: Metadata): number;
/**
 ...
 * ```
 */
export declare function getMetadataValue(metadata: Metadata, name: string): string | undefined;
