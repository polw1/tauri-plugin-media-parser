...
Follow the Rust documentation guidelines here:
   ...
   * Rust Book: [Making useful documentation comments][rust-doc-comments]
...
Quick project configuration checklist:
   ...
   * [ ] `Cargo.toml` file that specifies the Silvermine standard Rust `edition`
     (see the first heading in this document)
...
[rust-doc-comments]: https://doc.rust-lang.org/book/ch14-02-publishing-to-crates-io.html#making-useful-documentation-comments
